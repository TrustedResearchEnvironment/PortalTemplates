...
async function renderPlatformAdminDataSourceTypesPage() {
    ...
    try {
        ...
        const data = dataSourceTypes
        
        const rowCounts = dataSourceTypes.length
        
        const dataSourceTypesCount = document.getElementById('dataSourceTypesCount')
        dataSourceTypesCount.textContent = rowCounts
